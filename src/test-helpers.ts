...
export function createMockClient(
  overrides: Partial<TodoistClientInterface> = {}
): TodoistClientInterface {
  return {
...
export async function createTestServer(
  mockOverrides: Partial<TodoistClientInterface> = {}
) {
...
export function parseToolResponse(result: Awaited<ReturnType<Client["callTool"]>>): unknown {
